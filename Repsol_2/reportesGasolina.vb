...
Public Class reportesGasolina
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Repsol_2.reportesGasolina.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedreportesGasolina
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reportesGasolina = New reportesGasolina()
        rpt.Site = Me.Site
        Return rpt
    End Function
