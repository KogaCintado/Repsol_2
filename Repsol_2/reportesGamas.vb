...
Public Class reportesGamas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Repsol_2.reportesGamas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedreportesGamas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reportesGamas = New reportesGamas()
        rpt.Site = Me.Site
        Return rpt
    End Function
